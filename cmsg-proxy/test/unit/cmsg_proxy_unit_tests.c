...
/**
 * Function Tested: cmsg_proxy_service_info_init()
 *
 * Tests that the proxy tree is the correct length after cmsg_proxy_service_info_init()
...
/**
 * Function Tested: cmsg_proxy_find_service_from_url_and_verb()
 *
...
test_cmsg_proxy_find_service_from_url_and_verb__finds_correct_service_entry (void)
{
    ...
    entry = cmsg_proxy_find_service_from_url_and_verb ("/v1/test", CMSG_HTTP_PUT,
                                                       &url_parameters);
    NP_ASSERT_PTR_NOT_EQUAL (entry, NULL);
    NP_ASSERT_EQUAL (entry->http_verb, CMSG_HTTP_PUT);

    entry = cmsg_proxy_find_service_from_url_and_verb ("BAD URL", CMSG_HTTP_PUT,
                                                       &url_parameters);
    NP_ASSERT_PTR_EQUAL (entry, NULL);

    entry = cmsg_proxy_find_service_from_url_and_verb ("/v1/test", CMSG_HTTP_GET,
                                                       &url_parameters);
    NP_ASSERT_PTR_NOT_EQUAL (entry, NULL);
    NP_ASSERT_EQUAL (entry->http_verb, CMSG_HTTP_GET);

    entry = cmsg_proxy_find_service_from_url_and_verb ("/v1/test", CMSG_HTTP_PATCH,
                                                       &url_parameters);
    NP_ASSERT_PTR_EQUAL (entry, NULL);
...
/**
 * Function Tested: cmsg_proxy_create_client()
 *
...
/**
 * Function Tested: cmsg_proxy_clients_init()
 *
...
/**
 * Function Tested: cmsg_proxy_service_info_add()
 *
...
test_cmsg_proxy_service_info_add (void)
{
    ...
    cmsg_proxy_service_info_add (&array[2]);
    NP_ASSERT_EQUAL (g_node_n_nodes (proxy_entries_tree, G_TRAVERSE_ALL), 5);

    cmsg_proxy_service_info_add (&array[0]);
    ...
    cmsg_proxy_service_info_add (&array[1]);
    NP_ASSERT_EQUAL (g_node_n_nodes (proxy_entries_tree, G_TRAVERSE_ALL), 6);
}

/**
 * Function Tested: cmsg_proxy_tree_deinit()
 *
 * Tests that dynamically allocated memory is freed properly
 */
void
test_cmsg_proxy_tree_deinit (void)
{
    setup_standard_test_tree ();
...
/**
 * Function Tested: cmsg_proxy_parse_query_parameters()
 *
...
/**
 * Functions Tested: cmsg_proxy_service_info_add()
 *                   cmsg_proxy_service_info_conflicts()
 *

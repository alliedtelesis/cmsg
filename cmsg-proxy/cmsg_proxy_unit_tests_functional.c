...
{
    return cmsg_create_client_loopback (CMSG_SERVICE (cmsg_proxy_unit_tests, interface));
}

void
cmsg_proxy_unit_tests_interface_impl_test_put (const void *service,
                                               const cmsg_bool *recv_msg)
{
    /* Placeholder function as each RPC requires an IMPL function to link */
}

void
cmsg_proxy_unit_tests_interface_impl_test_get (const void *service)
{
    ...
    cmsg_proxy_unit_tests_interface_server_test_getSend (service, &send_msg);
}

void
cmsg_proxy_unit_tests_interface_impl_test1_get (const void *service)
{
    /* Placeholder function as each RPC requires an IMPL function to link */
}

void
cmsg_proxy_unit_tests_interface_impl_test_query_param (const void *service,
                                                       const
                                                       cmsg_proxy_unit_tests_query_param_test_msg
                                                       *recv_msg)
{
    /* Placeholder function as each RPC requires an IMPL function to link */
}
...
void
cmsg_proxy_unit_tests_interface_impl_test_additional_bindings (const void *service,
                                                               const
                                                               cmsg_proxy_unit_tests_additional_bindings_test_msg
                                                               *recv_msg)
{
    /* Placeholder function as each RPC requires an IMPL function to link */
}

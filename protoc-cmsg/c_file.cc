...
void FileGenerator::GenerateAtlHttpProxyDefinition(io::Printer* printer) {
  ...
  // include the cmsg proxy header for type definitions
  printer->Print("#include <cmsg-proxy/cmsg_proxy.h>\n");
  printer->Print("\n");

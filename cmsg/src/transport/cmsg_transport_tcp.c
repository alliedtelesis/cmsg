...
static int32_t
cmsg_transport_tcp_rpc_server_send (int socket, cmsg_transport *transport, void *buff,
                                    int length, int flag)
{
 ...
 */
static int32_t
cmsg_transport_tcp_oneway_server_send (int socket, cmsg_transport *transport, void *buff,
                                       int length, int flag)
{
    return 0;
}

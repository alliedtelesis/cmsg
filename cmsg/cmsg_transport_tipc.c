...
csmg_transport_peek_for_header (cmsg_recv_func recv_wrapper, void *recv_wrapper_data,
                                 ...
                                 ProtobufCMessage **messagePtPt)
{
    ...
    *messagePtPt = NULL;
    ...
    ret = csmg_transport_peek_for_header (cmsg_transport_tipc_recv,
    ...
    if (nbytes == (int) sizeof (cmsg_header))
    {
        ...
        nbytes =
            recv (transport->connection.sockets.client_socket, recv_buffer,
                  dyn_len, MSG_WAITALL);
    ...
    else if (nbytes > 0)
    {
        ...
        nbytes =
            recv (transport->connection.sockets.client_socket, recv_buffer, nbytes,
                  MSG_WAITALL);
        CMSG_FREE (recv_buffer);
        recv_buffer = NULL;
    }

...
#ifndef GOOGLE_PROTOBUF_COMPILER_C_ATL_MESSAGE_H__
#define GOOGLE_PROTOBUF_COMPILER_C_ATL_MESSAGE_H__
...
class AtlMessageGenerator {
 public:
  // See generator.cc for the meaning of dllexport_decl.
  explicit AtlMessageGenerator(const Descriptor* descriptor,
 ...
 private:
  ...
  scoped_array<scoped_ptr<AtlMessageGenerator> > nested_generators_;
  scoped_array<scoped_ptr<EnumGenerator> > enum_generators_;
  scoped_array<scoped_ptr<ExtensionGenerator> > extension_generators_;

  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(AtlMessageGenerator);
};
...
#endif  // GOOGLE_PROTOBUF_COMPILER_C_ATL_MESSAGE_H__
